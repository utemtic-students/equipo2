     ...
     <div id="wrapper">
        ...
        <div id="header">
            <div class="container">
                ...
                <!-- Logo -->
                <div id="logo">
                    <h1><a href="#">Busqueda Avanzada</a></h1>
                </div>
            ...
            <div class="container-fluid">
                ...
                <nav id="nav">
                    <ul>
                        ...
                        <li><a href="twocolumn1.html">Busqueda</a></li>
                    </ul>
                </nav>
            ...
            <div class="container">
                <div class="row">
                    <div class="9u">
                        <section>
                            <header>
                                <h2>La Programacion - Nuestros Algoritmos</h2>
                            </header>
                            <a href="#" class="image full"><img src="images/pics12.jpg" alt=""></a>
                            <p>Un algoritmo es una secuencia no ambigua, finita y ordenada de instrucciones que han de seguirse para resolver un problema. Un programa normalmente implementa (traduce a un lenguaje de programación concreto) uno o más algoritmos. Un algoritmo puede expresarse de distintas maneras: en forma gráfica, como un diagrama de flujo, en forma de código como en pseudocódigo o un lenguaje de programación, en forma explicativa, etc.
...
Se han propuesto diversas técnicas de programación cuyo objetivo es mejorar tanto el proceso de creación de software como su mantenimiento. Entre ellas, se pueden mencionar las siguientes</p>
